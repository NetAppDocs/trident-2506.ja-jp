...
* 4 リリース期間外のリリースからアップグレードする場合は、複数段階のアップグレードを実行します。アップグレード手順については、link:../earlier-versions.html["以前のバージョン"]アップグレード元のバージョンを、4 つのリリースの期間に収まる最新のリリースにアップグレードします。たとえば、23.07 を実行していて、25.06 にアップグレードする場合:
+
