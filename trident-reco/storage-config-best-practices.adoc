...
ブロック サイズと帯域幅は IOPS の数に直接影響します。ブロック サイズが大きくなるにつれて、システムはより大きなブロック サイズを処理するために必要なレベルまで帯域幅を増加させます。帯域幅が増加すると、システムが達成できる IOPS の数は減少します。参照 https://www.netapp.com/pdf.html?item=/media/10502-tr-4644pdf.pdf["SolidFireサービス品質"^]QoS とパフォーマンスの詳細については、こちらをご覧ください。
...
* https://www.netapp.com/pdf.html?item=/media/10513-tr-4635pdf.pdf["NetApp SolidFireと Cassandra"^]
* https://www.netapp.com/pdf.html?item=/media/10511-tr4606pdf.pdf["SolidFireにおけるOracleのベストプラクティス"^]
* https://www.netapp.com/pdf.html?item=/media/10512-tr-4610pdf.pdf["SolidFireにおけるPostgreSQLのベストプラクティス"^]
